...
const Newsletter = ({ isContainer = true }: NewsletterProps) => {
  return (
    <section className="my-8 w-full">
      <div className={cn(isContainer && "container")}>
        <div className="rounded-lg bg-black px-6 py-7 lg:px-[64px] lg:py-[43px]">
          <div className="flex flex-col items-center justify-between max-lg:gap-8 lg:flex-row">
            <div className="flex-1">
              <h3 className="text-pretty font-integral text-[32px] font-bold text-white lg:text-[40px]">

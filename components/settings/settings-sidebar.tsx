...
import { User, Bell, Lock, Globe, CreditCard, HelpCircle, LogOut, Palette } from "lucide-react"
  ...
  return (
    <div className="sticky top-20 space-y-6">
      <div className="space-y-1">
        ...
        <p className="px-2 text-sm text-muted-foreground">Manage your account settings and preferences.</p>
      </div>
